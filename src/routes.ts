...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { ClientController } from './clients/clientsController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
const models: TsoaRoute.Models = {
    ...
    "Pick_User.email-or-name-or-phoneNumbers_": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"email":{"dataType":"string","required":true,"validators":{"pattern":{"errorMsg":"please provide correct email","value":"^(.+)@(.+)$"}}},"name":{"dataType":"string","required":true},"phoneNumbers":{"dataType":"array","array":{"dataType":"string"},"required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "UserCreationParams": {
        "dataType": "refAlias",
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/clients',
            ...
            ...(fetchMiddlewares<RequestHandler>(ClientController.prototype.getClients)),

            function ClientController_getClients(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/persons',
            ...
            ...(fetchMiddlewares<RequestHandler>(PersonController.prototype.getPerson)),

            function PersonController_getPerson(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getPerson.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
